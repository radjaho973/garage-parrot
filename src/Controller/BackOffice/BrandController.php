...
class BrandController extends AbstractController
{
    ...
    {
        return $this->render('back_office/brand/index.html.twig', [
    ...
    public function new(Request $request, BrandRepository $brandRepository): Response
    {
        ...
        return $this->render('back_office/brand/new.html.twig', [
            'brand' => $brand,
            'form' => $form,
        ]);
    }
    ...
    // {
    //     return $this->render('back_office/brand/show.html.twig', [
    //         'brand' => $brand,
    //     ]);
    // }
    ...
    public function edit(Request $request, Brand $brand, BrandRepository $brandRepository): Response
    {
        ...
        return $this->render('back_office/brand/edit.html.twig', [
            'brand' => $brand,
            'form' => $form,
        ]);
    }
